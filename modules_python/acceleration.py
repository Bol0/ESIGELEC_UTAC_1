...
class rtmaps_python(BaseComponent):
    ...
    def Dynamic(self):
        self.add_input("angleErreur", rtmaps.types.ANY)
        self.add_input("distance_obstacle", rtmaps.types.ANY)
        self.add_output("acceleration", rtmaps.types.AUTO);
    ...
    def Core(self):
        ...
        self.outputs["acceleration"].write(Utmx)
